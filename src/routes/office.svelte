...
<div>
    <Canvas>
        ...
        <GLTF
            url="/static/models/office/Office_Chair_Brown_01.gltf"
            receiveShadow
        ...
        />
        <GLTF
            url="/static/models/office/Office_Table_Brown_3x1_01.gltf"
            receiveShadow
    ...
    />
        ...
        />
        <GLTF
            url="/static/models/office/Office_Table_Brown_2x2_02.gltf"
        ...
        />
        <GLTF
            url="/static/models/office/Office_Misc_Trashcan_Small_03.gltf"
            receiveShadow
            position={{ y: -0.4, x: 4, z: -2.5 }}
            rotation={{ y: 90 * (Math.PI / 180) }}
        />
        <GLTF
            url="/static/models/office/Office_Misc_Printer.gltf"
            receiveShadow
        ...
        />
        <GLTF
            url="/static/models/office/Office_Misc_Papers.gltf"
            receiveShadow
        ...
        />
        <GLTF
            url="/static/models/office/Office_Misc_Whiteboard_01.gltf"
            receiveShadow
        ...
        />
        <GLTF
            url="/static/models/office/Office_Misc_Cabinet_02.gltf"
            receiveShadow
        ...
        />
        <GLTF
            url="/static/models/office/Office_Couch_Brown_02.gltf"
            receiveShadow
            rotation={{ y: 90 * (Math.PI / 180) }}
        ...
        />
        <GLTF
            url="/static/models/office/Office_Table_Coffee_03_Brown.gltf"
            receiveShadow
        ...
        />
        <GLTF
            url="/static/models/office/boss-sitting-1.gltf"
            receiveShadow
            rotation={{ y: 90 * (Math.PI / 180) }}
        ...
        />
        <GLTF
            url="/static/models/office/john-dodi-sitting-1.gltf"
            receiveShadow
            rotation={{ y: 90 * (Math.PI / 180) }}
