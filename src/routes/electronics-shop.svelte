...
<div>
    ...
    />
        ...
        <GLTF
            url="/static/models/office/Office_Table_White_2x1_02.gltf"
            position={{ y: 0.1, x: 4.5, z: 0 }}
        />

        <GLTF
            url="/static/models/office/Office_Chair_White_04.gltf"
        ...
        <GLTF
            url="/static/models/office/Office_Misc_Phone.gltf"
            position={{ y: 1.2, x: 4.5, z: -0.45 }}
            scale={{ x: 0.6, y: 0.6, z: 0.6 }}
        />

        <GLTF
            url="/static/models/office/Office_Misc_Plant_03.gltf"
            position={{ y: 0.1, x: 5.7, z: 3.2 }}
        />

       

        <GLTF
            url="/static/models/shop/rack/scene.gltf"
            position={{ y: 0.1, x: 2.5, z: 3.7 }}
            rotation={{ y: Math.PI / 2 }}
        />

        <GLTF
            url="/static/models/shop/delux_bookshelf/scene.gltf"
        ...
        <!-- Rack -->
        <GLTF
            url="/static/models/shop/closed-circuit-2.gltf"
        ...
        <GLTF
            url="/static/models/shop/open-circuit-3.gltf"
        ...
        <GLTF
            url="/static/models/shop/open-circuit-1.gltf"
        ...
        <GLTF
            url="/static/models/shop/closed-circuit-4.gltf"
        ...
        <!-- Shelf A -->
        <GLTF
            url="/static/models/shop/closed-circuit-3.gltf"
        ...
        <GLTF
            url="/static/models/shop/closed-circuit-1.gltf"
        ...
        <GLTF
            url="/static/models/shop/open-circuit-2.gltf"
        ...
        />
        <GLTF
            url="/static/models/shop/clerk-sitting-1.gltf"
            receiveShadow
